...
//        );
        ...
        H1 heroText = new H1("CLASS ATTENDANCE SHEET SYSTEM");
        H6 subText = new H6("Manege Attendance and class activities privately...");
        Div container = new Div(heroText, subText);
        container.setSizeUndefined();
        container.addClassNames("dashboard-container", "dashboard-div");

        HorizontalLayout hLayout = new HorizontalLayout(container);
        hLayout.addClassNames("dashboard-container", "dashboard-hlayout");
        hLayout.setSizeFull();
