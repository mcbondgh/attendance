...
@PageTitle("Set Up")
@Route(value = "set-up", layout = MainLayout.class)
@AnonymousAllowed
public class SetUpView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public SetUpView() {
        addClassName("set-up-view");
        setSizeFull();
        grid.setHeight("100%");
